...
local set_colors = function(c)
	return {
		...
		["@variable.parameter.typescript"] = { fg = c.vscLightBlue, bg = c.vscNone },
		...
		["@lsp.typemod.enumMember.readonly.typescript"] = { fg = c.vscAccentBlue, bg = c.vscNone },
		["@lsp.type.class.typescript"] = { fg = c.vscBlueGreen, bg = c.vscNone },
		["@lsp.type.interface.typescript"] = { fg = c.vscBlueGreen, bg = c.vscNone },
		["@lsp.typemod.member.declaration.typescript"] = { fg = c.vscYellow, bg = c.vscNone },
