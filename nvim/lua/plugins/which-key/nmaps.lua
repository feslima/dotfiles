local M = {
	...
	mappings = {
		...
		{ "<leader>cp", group = "+AI code completion" },
		{ "<leader>cpc", "<cmd>Minuet cmp toggle<CR>", desc = "Toggle AI completion on nvim-cmp" },
		{ "<leader>cpv", "<cmd>Minuet virtualtext toggle<CR>", desc = "Toggle AI completion via virtualtext" },
